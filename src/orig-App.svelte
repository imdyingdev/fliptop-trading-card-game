...
<main>
	<header>
		...
		<section class="info">
			<h2>Your Custom Holo Card</h2>
			<p class="small">
				This is your custom image with a "Holo Rare" (full holo) effect applied. Move your mouse over it to see it work!
			</p>
		</section>

		<div class="showcase">
			<CustomCard
				img="/custom/emar-industriya.png"
				rarity="rare ultra"
				showcase={true}
			/>
		</div>
